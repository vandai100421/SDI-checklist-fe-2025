...
import { ChecklistStackParamList, MainStackParamList } from "../types/navigation";
...
export default function ({
  ...
  const routeToDetail = (checklistID: number) => {
    navigation.navigate("DetailChecklist", { checklistID })
  }

  return (
    <Layout>
      <TopNav
        middleContent="Checklist"
        leftContent={
          <Ionicons
      ...
      <ScrollView
        ...
        <Checklist routeToDetail={routeToDetail} />
      </ScrollView>
    </Layout>
  );
}
